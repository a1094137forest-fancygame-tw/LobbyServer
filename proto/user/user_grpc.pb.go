...
const (
	User_GetMemberList_FullMethodName = "/user.User/GetMemberList"
	User_SetMemberData_FullMethodName = "/user.User/SetMemberData"
	User_KickOutMember_FullMethodName = "/user.User/KickOutMember"
)
